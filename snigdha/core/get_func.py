        ...
        if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
            ...
            if chat in saved_channel_ids:
                await app.edit_message_text(
                    ...
                    "Sorry! This channel is protected by **__AnkiT__**."
                )
                return
...
get_user_rename_preference = lambda user_id: user_rename_preferences.get(str(user_id), 'AnkiT')
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        try:
            ...
            await event.edit("📤 Choose your preferred upload method:\n\n__**Note:** SpyLib ⚡, built on Telethon(base), by AnkiT still in beta.__", buttons=buttons)
        except Exception as e:
